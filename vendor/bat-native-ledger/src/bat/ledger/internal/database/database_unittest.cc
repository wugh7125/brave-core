...
// npm run test -- brave_unit_tests --filter=DatabaseTest.*
...
class DatabaseTest : public ::testing::Test {
 public:
  void TestCallback(const ledger::Result result) {
    LOG(ERROR) << "NEJC 2";
 ...
 protected:
  ...
  void Initialize(
      ...
      const bool execute_script = false) {
    database_ = std::make_unique<Database>(mock_ledger_impl_.get());
    ASSERT_NE(database_, nullptr);
    database_->Initialize(execute_script, callback);
  }
...
//      int start_version,
//      int end_version) {
//    const std::string file_name = base::StringPrintf(
//        "publisher_info_db_v_%d",
//        start_version);
//
...
//
//    database =
//    std::make_unique<Database>(*db_file, end_version);
...
TEST_F(DatabaseTest, SaveContributionInfo) {
  auto callback = std::bind(&DatabaseTest::TestCallback,
      this,
      _1);
...
//
//  bool success = database->SaveContributionInfo(info->Clone());
//  EXPECT_TRUE(success);
//
...
//TEST_F(DatabaseTest, SavePublisherInfo) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//  EXPECT_TRUE(database->ClearAndInsertServerPublisherList(list));
//
//  bool success = database->SavePublisherInfo(info->Clone());
//  EXPECT_TRUE(success);
//
...
//
//  success = database->SavePublisherInfo(info->Clone());
//  EXPECT_TRUE(success);
//
...
//}
//
//TEST_F(DatabaseTest, GetExcludedList) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//
//  bool success = database->SaveActivityInfo(info->Clone());
//  EXPECT_TRUE(success);
//
//  /**
...
//
//  success = database->SaveActivityInfo(info->Clone());
//  EXPECT_TRUE(success);
//  /**
//   * Check Excluded List is correct
//   */
//  ledger::PublisherInfoList pub_list;
//  success = database->GetExcludedList(&pub_list);
//  EXPECT_TRUE(success);
...
//  success = database->GetActivityList(0, 0, std::move(filter), &pub_list);
//  EXPECT_TRUE(success);
//  EXPECT_EQ(1UL, pub_list.size());
//
...
//}
//
//TEST_F(DatabaseTest, SaveActivityInfo) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//}
//
//TEST_F(DatabaseTest, SaveMediaPublisherInfo) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//
//  bool success = database->SaveMediaPublisherInfo(
//      media_key,
//      publisher_id);
//  EXPECT_TRUE(success);
//
...
//  publisher_id = "id_new";
//
//  success = database->SaveMediaPublisherInfo(
//      media_key,
//      publisher_id);
//  EXPECT_TRUE(success);
//
...
//}
//
//TEST_F(DatabaseTest, SaveRecurringTip) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//  info->created_at = base::Time::Now().ToJsTime();
//
//  bool success = database->SaveRecurringTip(info->Clone());
//  EXPECT_TRUE(success);
//
...
//  info->amount = 30;
//
//  success = database->SaveRecurringTip(info->Clone());
//  EXPECT_TRUE(success);
//
...
//}
//
//TEST_F(DatabaseTest, GetPanelPublisher) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//  EXPECT_EQ(database->GetPanelPublisher(std::move(filter_1)),
...
//  filter_2->id = "test";
//  EXPECT_EQ(database->GetPanelPublisher(std::move(filter_2)),
//            static_cast<ledger::PublisherInfoPtr>(nullptr));
//
//  /**
...
//
//  bool success = database->SaveActivityInfo(std::move(info));
//  EXPECT_TRUE(success);
//
...
//      database->GetPanelPublisher(std::move(filter_4));
//  EXPECT_TRUE(result);
//  EXPECT_EQ(result->id, "page.com");
//  EXPECT_EQ(result->percent, 0u);
//}
//
//TEST_F(DatabaseTest, SaveActivityInfos) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//
//  bool success = database->SaveActivityInfos(std::move(list));
//  EXPECT_TRUE(success);
//
//  /**
//   * Empty list
...
//
//  success = database->SaveActivityInfos(std::move(list_empty));
//  EXPECT_TRUE(success);
//
//  /**
...
//
//  success = database->SaveActivityInfos(std::move(list));
//  EXPECT_FALSE(success);
//}
//
//TEST_F(DatabaseTest, SavePendingContribution) {
//  /**
//   * Good path
//   */
//  base::ScopedTempDir temp_dir;
...
//
//  bool success = database->SavePendingContribution(std::move(list));
//  EXPECT_TRUE(success);
//
//  std::string query =
...
//}
//
//TEST_F(DatabaseTest, GetActivityList) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//  EXPECT_TRUE(database->SaveActivityInfo(info->Clone()));
//
//  // with duration
//  info->id = "publisher_2";
...
//  EXPECT_TRUE(database->GetActivityList(0, 0, std::move(filter_1), &list_1));
...
//  EXPECT_TRUE(database->GetActivityList(0, 0, std::move(filter_2), &list_2));
...
//  EXPECT_TRUE(database->GetActivityList(0, 0, std::move(filter_3), &list_3));
...
//  EXPECT_TRUE(database->GetActivityList(0, 0, std::move(filter_4), &list_4));
...
//}
//
//TEST_F(DatabaseTest, Migrationv3tov4) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
...
//  EXPECT_EQ(database->GetTableVersionNumber(), 4);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(4));
//}
//
//TEST_F(DatabaseTest, Migrationv4tov5) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
...
//  EXPECT_EQ(database->GetTableVersionNumber(), 5);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(5));
//}
//
//TEST_F(DatabaseTest, Migrationv5tov6) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
...
//
//  EXPECT_EQ(database->GetTableVersionNumber(), 6);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(6));
//}
//
//TEST_F(DatabaseTest, Migrationv4tov6) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
...
//}
//
//TEST_F(DatabaseTest, Migrationv6tov7) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 6, 7);
//
//  EXPECT_TRUE(database->Init());
//  EXPECT_EQ(database->GetTableVersionNumber(), 7);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(7));
//}
//
//TEST_F(DatabaseTest, Migrationv7tov8) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 7, 8);
//  EXPECT_TRUE(database->Init());
//
//  EXPECT_EQ(database->GetTableVersionNumber(), 8);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(8));
//}
//
//TEST_F(DatabaseTest, Migrationv7tov8_ContributionInfo) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 7, 8);
//  EXPECT_TRUE(database->Init());
...
//}
//
//TEST_F(DatabaseTest, Migrationv7tov8_PendingContribution) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 7, 8);
//  EXPECT_TRUE(database->Init());
...
//}
//
//TEST_F(DatabaseTest, Migrationv8tov9) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 8, 9);
//  EXPECT_TRUE(database->Init());
//
//  EXPECT_EQ(database->GetTableVersionNumber(), 9);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(9));
//}
//
//TEST_F(DatabaseTest, Migrationv9tov10) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 9, 10);
//  EXPECT_TRUE(database->Init());
//
//  EXPECT_EQ(database->GetTableVersionNumber(), 10);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(10));
//}
//
//TEST_F(DatabaseTest, Migrationv10tov11) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 10, 11);
//  EXPECT_TRUE(database->Init());
//
//  EXPECT_EQ(database->GetTableVersionNumber(), 11);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(11));
//}
//
//TEST_F(DatabaseTest, Migrationv10tov11_ContributionInfo) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 10, 11);
//  EXPECT_TRUE(database->Init());
...
//}
//
//TEST_F(DatabaseTest, Migrationv11tov12) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 11, 12);
//  EXPECT_TRUE(database->Init());
//
//  ASSERT_EQ(database->GetTableVersionNumber(), 12);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(12));
//}
//
//TEST_F(DatabaseTest, Migrationv11tov12_ContributionInfo) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 11, 12);
//  EXPECT_TRUE(database->Init());
...
//  database->GetPendingContributions(&list);
...
//}
//
//TEST_F(DatabaseTest, Migrationv12tov13) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 12, 13);
//  EXPECT_TRUE(database->Init());
//
//  ASSERT_EQ(database->GetTableVersionNumber(), 13);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(13));
//}
//
//TEST_F(DatabaseTest, Migrationv12tov13_Promotion) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 12, 13);
//  EXPECT_TRUE(database->Init());
...
//}
//
//TEST_F(DatabaseTest, Migrationv13tov14) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 13, 14);
//  EXPECT_TRUE(database->Init());
//
//  ASSERT_EQ(database->GetTableVersionNumber(), 14);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(14));
//}
//
//TEST_F(DatabaseTest, Migrationv13tov14_UnblindedToken) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 13, 14);
//  EXPECT_TRUE(database->Init());
...
//
//  auto list = database->GetAllUnblindedTokens();
...
//
//  ledger::PromotionPtr promotion = database->GetPromotion(
//      "36baa4c3-f92d-4121-b6d9-db44cb273a02");
//  EXPECT_EQ(promotion->approximate_value, 1.25);
//}
//
//TEST_F(DatabaseTest, Migrationv14tov15) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateMigrationDatabase(&temp_dir, &db_file, 14, 15);
//  EXPECT_TRUE(database->Init());
//
//  ASSERT_EQ(database->GetTableVersionNumber(), 15);
//
//  const std::string schema = database->GetSchema();
//  EXPECT_EQ(schema, GetSchemaString(15));
//}
//
//TEST_F(DatabaseTest, DeleteActivityInfo) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//
//  // publisher key is missing
//  EXPECT_FALSE(database->DeleteActivityInfo("", 2));
//
//  // reconcile stamp is missing
//  EXPECT_FALSE(database->DeleteActivityInfo("publisher_1", 0));
//
//  // publisher doesn't exist
//  EXPECT_TRUE(database->DeleteActivityInfo("publisher_3", 2));
//
//  // publisher is deleted
//  EXPECT_TRUE(database->DeleteActivityInfo("publisher_1", 2));
//  ledger::PublisherInfoList list;
//  auto filter = ledger::ActivityInfoFilter::New();
//  filter->excluded = ledger::ExcludeFilter::FILTER_ALL;
//  EXPECT_TRUE(database->GetActivityList(0, 0, std::move(filter), &list));
...
//}
//
//void DatabaseTest::PreparePendingContributions() {
//  // Insert publishers
//  auto info = ledger::PublisherInfo::New();
//  info->id = "key1";
//  info->status = ledger::PublisherStatus::NOT_VERIFIED;
...
//
//  success = database->SavePendingContribution(std::move(list));
//  EXPECT_TRUE(success);
//  EXPECT_EQ(CountTableRows("pending_contribution"), 4);
//}
//
//TEST_F(DatabaseTest, GetPendingContributions) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//  database->GetPendingContributions(&select_list);
...
//}
//
//TEST_F(DatabaseTest, RemovePendingContributions) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//   * Good path
//  */
//  bool success = database->RemovePendingContributions(1);
//  EXPECT_TRUE(success);
//
//  ledger::PendingContributionInfoList list;
//  database->GetPendingContributions(&list);
...
//  */
//  success = database->RemovePendingContributions(10);
//  EXPECT_TRUE(success);
//  EXPECT_EQ(CountTableRows("pending_contribution"), 3);
//}
//
//
//TEST_F(DatabaseTest, RemoveAllPendingContributions) {
//  base::ScopedTempDir temp_dir;
//  base::FilePath db_file;
//  CreateTempDatabase(&temp_dir, &db_file);
//
...
//   * Good path
//  */
//  bool success = database->RemoveAllPendingContributions();
//  EXPECT_TRUE(success);
