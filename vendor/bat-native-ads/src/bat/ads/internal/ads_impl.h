...
class AdsImpl : public Ads {
 public:
  ...
  CreativePublisherAdList GetEligiblePublisherAds(
      const CreativePublisherAdList& ads);
  CreativePublisherAdList GetUnseenPublisherAdsAndRoundRobinIfNeeded(
      const CreativePublisherAdList& ads) const;
  CreativePublisherAdList GetUnseenPublisherAds(
      const CreativePublisherAdList& ads) const;
  CreativePublisherAdList GetPublisherAdsForUnseenAdvertisers(
      const CreativePublisherAdList& ads) const;
